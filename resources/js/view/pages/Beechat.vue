<template>
    ...
    <div class="profile">
        ...
        <ContentChat :ChatUser="ChatUser"></ContentChat>
    </div>
...
import ContentChat from '../components/ChatComponent/ContentChat.vue';
...
export default {
    ...
    mounted() {
        ...
        // var VueThis = this;
        // window.Echo.channel("channelchat" + this.userInfor.id).listen(
        //     "ChatEvent",
        //     function (res) {
        //         console.log(res);
        //     }
