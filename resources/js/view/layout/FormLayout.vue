...
import ProfileFrom from "../components/FormComponent/ProfileForm.vue";
import MucsicForm from "../components/FormComponent/MusicForm.vue";
import VideoForm from "../components/FormComponent/VideoForm.vue";
